...
export default function TournamentHubPage() {
 ...
 return (
 <main className="min-h-screen bg-transparent text-white selection:bg-red-500/30">
 <Navbar />
 ...
 <h1 className="text-4xl md:text-6xl font-rajdhani font-black uppercase tracking-tight mb-2 drop-">
 {tournament.name}
 </h1>
 ...
 <span className="text-3xl filter drop-">👑</span>
 <div>
