    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
                <div className="absolute top-1/4 left-10 w-[1px] h-64 bg-gradient-to-b from-transparent via-[#dc143c]/20 to-transparent"></div>
                <div className="absolute bottom-1/4 right-10 w-[1px] h-64 bg-gradient-to-b from-transparent via-[#dc143c]/20 to-transparent"></div>
            ...
            <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-40 items-center">
                    ...
                    <div className="mission-heading">
                        ...
                        <h2 className="text-6xl md:text-9xl font-rajdhani font-black tracking-tighter leading-[0.85] text-white uppercase italic">
                            ...
                            <span className="block opacity-0 text-[#dc143c] relative">
                                Of Play
                                <div className="absolute -right-12 top-1/2 -translate-y-1/2 w-4 h-4 bg-[#dc143c] animate-ping opacity-20"></div>
                            </span>
                        </h2>
                    </div>
                    ...
                    <div className="parallax-element">
                        <div className="bg-white/[0.02] border border-white/10 p-12 relative overflow-hidden group hover:border-[#dc143c]/30 transition-all duration-700">
                            {/* Card Corner Accent */}
                            <div className="absolute top-0 right-0 w-16 h-16 bg-[#dc143c]/10 -translate-x-1/2 -translate-y-1/2 rotate-45 group-hover:bg-[#dc143c]/20 transition-colors"></div>

                            <div className="mission-text opacity-0 space-y-12">
                                <div className="space-y-6">
                                    <div className="flex items-center gap-2 mb-4">
                                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                        <span className="text-[10px] text-gray-500 font-mono tracking-widest uppercase">System: Fully_Autonomous</span>
                                    </div>
                                    <p className="text-xl md:text-2xl text-white font-light leading-relaxed font-rajdhani italic">
                                    ...
                                    <p className="text-sm text-gray-400 leading-relaxed max-w-lg border-l-2 border-[#dc143c] pl-8">
                                ...
                                <div className="grid grid-cols-3 gap-12 pt-12 border-t border-white/10">
                                    <div className="group/stat">
                                        <div className="text-5xl font-rajdhani font-black text-white group-hover/stat:text-[#dc143c] transition-colors tabular-nums">
                                            0{counts.divisions}
                                        </div>
                                        <div className="text-[10px] text-gray-600 uppercase tracking-widest font-bold mt-2">
                                            Divisions
                                        </div>
                                    </div>
                                    <div className="group/stat">
                                        ...
                                        <div className="text-[10px] text-gray-600 uppercase tracking-widest font-bold mt-2 hover:text-[#dc143c] transition-colors">
                                            Trophy_Room
                                        </div>
                                    </div>
                                    <div className="group/stat">
                                        <div className="text-5xl font-rajdhani font-black text-[#dc143c] tabular-nums">
                                ...
                                <div className="pt-8">
                                    <button className="flex items-center gap-4 text-[10px] font-bold text-white tracking-[0.4em] uppercase group/btn">
                                        <span className="underline underline-offset-8">Execute Protocol</span>
