...
export default function Contact() {
    ...
    return (
        <section id="contact" ref={sectionRef} className="py-32 relative bg-[#050505]">
            <div className="contact-content opacity-0 max-w-2xl mx-auto px-6 text-center relative z-10 glass-panel p-12 rounded-xl border-t border-[#dc143c]/30">
