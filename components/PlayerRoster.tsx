...
export default function PlayerRoster() {
 ...
 <span className="text-[20vw] font-black uppercase leading-none">
 AKATSUKI
 </span>
 </div>
 ...
 {/* Coming Soon Message */}
 <div className="coming-soon-content opacity-0 py-20 text-center space-y-8 glass-panel max-w-3xl mx-auto rounded-xl border border-white/5 ">
 <div className="inline-block relative">
 <div className="absolute -inset-4 bg-[#dc143c]/20 blur-xl rounded-full mix-blend-screen"></div>
 <h3 className="text-6xl md:text-8xl font-black text-white tracking-[0.1em] uppercase relative">
 Coming <span className="text-[#dc143c] ">Soon</span>
 </h3>
 </div>

 <div className="max-w-xl mx-auto px-4">
 <p className="text-zinc-400 text-sm md:text-md font-mono tracking-widest leading-relaxed uppercase relative z-10">
 ...
 {[1, 2, 3].map((i) => (
 <div key={i} className="w-2 h-2 bg-[#dc143c] " style={{ animationDelay: `${i * 200}ms` }}></div>
 ))}
 </div>
 <div className="w-16 h-[1px] bg-white/10 mt-3"></div>
 </div>
